...
public class RegistrainoDesignmodo {
	private BaseTest page;
	
	public void beforeExecution() throws IOException
	 {
	   //runmode of the test Y or N
	  if(Testutil.isSkip(BaseTest.datatable_suite1, "Designmodo")) //Designdemo -->testcase name
	...
	@Test(dataProvider ="testParameterData")
	 public void testdesignmodoRegisterPageObjects(String rusername, String rfirstname, String rlastname, String regemail, String rpassword, String rcpassword )throws Exception
	 {
		 page.openURL(Config.url);
		 page.designmodoreg(rusername, rfirstname, rlastname, regemail, rpassword, rcpassword);
	    Thread.sleep(4000);
	 }
	@BeforeTest
	...
	@AfterTest
	 ...
	 public static Object[][] testParameterData(Method method) throws Exception
	 {
		 ...
		 BaseTest.initialize(); 
		 Object data[][]=Testutil.getData(BaseTest.datatable_suite1, "Designmodo");//sheetname
	     return data;
	 }
